...
url = (
    ...
    "section-31-faculty-of-arts-and-science/section-31-200-department-of-"
    "mathematics-and-statistics/mathematics-and-statistics-courses.html"
)
...
for block in course_blocks:
    try:
        ...
        # Only process courses with titles starting with "MATH" or "MAST"
        if title and (title.startswith("MATH") or title.startswith("MAST")):
...
output_path = 'MATH_MAST_courses.json'
